return {
  ...
  dependencies = {
    -- ts-autotag atulizes treesitter to understand the code structure to automatically close tsx tags
  ...
  config = function()
    ...
    ts_config.setup({
      -- make sure we have vim, vimdoc, lua, laja, javascript, typescript, html, css, json, tsx, markdown, markdown inline and gitignore highlighting servers
      ...
      -- enable tsx auto closing tag create
      autotag = {
        enable = true,
      },
    })
